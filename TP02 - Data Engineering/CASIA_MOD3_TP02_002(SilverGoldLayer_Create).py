...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE silver.customeraddress (
# MAGIC     _tf_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL, -- Incremental surrogate key
# MAGIC
# MAGIC     -- Source table columns
# MAGIC     customer_id INT,
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE silver.productdescription (
# MAGIC     _tf_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL, -- Incremental surrogate key
# MAGIC
# MAGIC     -- Source table columns
...
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TABLE silver.productmodel    (
# MAGIC     _tf_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL, -- Incremental surrogate key
# MAGIC
# MAGIC     -- Source table columns
# MAGIC     product_model_id INT,
...
# MAGIC ) ;
# MAGIC
# MAGIC CREATE OR REPLACE TABLE silver.productmodelproductdescription (
# MAGIC     _tf_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL, -- Incremental surrogate key
# MAGIC
# MAGIC     -- Source table columns
# MAGIC     product_model_id INT  ,
...
# MAGIC   prod_sell_start_date TIMESTAMP,
# MAGIC   prod_sell_end_date TIMESTAMP,
# MAGIC   prod_discontinued_date TIMESTAMP,
# MAGIC   prod_thumbnail_photo BINARY,
# MAGIC   prod_thumbnail_photo_filename STRING,
# MAGIC   prod_model_name STRING,
# MAGIC   prod_catalog_description STRING,
# MAGIC   prod_instructions STRING,
# MAGIC
# MAGIC   -- Technical columns
# MAGIC   _tf_create_date TIMESTAMP,
# MAGIC   _tf_update_date TIMESTAMP
...
# MAGIC   prod_sell_start_date,
# MAGIC   prod_sell_end_date,
# MAGIC   prod_discontinued_date,
# MAGIC   prod_thumbnail_photo,
# MAGIC   prod_thumbnail_photo_filename,
# MAGIC   prod_model_name,
# MAGIC   prod_catalog_description,
# MAGIC   prod_instructions,
# MAGIC   _tf_create_date,
# MAGIC   _tf_update_date
# MAGIC )
# MAGIC SELECT
...
# MAGIC   p.size,
# MAGIC   p.weight,
# MAGIC   p.product_category_id,
# MAGIC   p.product_model_id,
# MAGIC   p.sell_start_date,
# MAGIC   p.sell_end_date,
# MAGIC   p.discontinued_date,
# MAGIC   p.thumbnail_photo,
# MAGIC   p.thumbnail_photo_filename,
# MAGIC   pm.name AS prod_model_name,
# MAGIC   pm.catalog_description,
# MAGIC   pm.instructions,
# MAGIC   current_timestamp() AS _tf_create_date,
# MAGIC   current_timestamp() AS _tf_update_date
# MAGIC FROM silver.product p
# MAGIC LEFT JOIN silver.productmodel pm
# MAGIC   ON p.product_model_id = pm.product_model_id;
# MAGIC CREATE OR REPLACE TABLE gold.dim_customer (
# MAGIC   -- Incremental surrogate key
# MAGIC   _tf_dim_customer_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,
# MAGIC
...
# MAGIC   prod_product_category_id INT,
# MAGIC   prod_product_category_name STRING,
# MAGIC   prod_parent_product_category_id INT,
# MAGIC   prod_parent_product_category_name STRING,
# MAGIC   prod_grandparent_product_category_id INT,
# MAGIC   prod_grandparent_product_category_name STRING,
# MAGIC   _tf_create_date TIMESTAMP,
# MAGIC   _tf_update_date TIMESTAMP
# MAGIC );
# MAGIC
...
# MAGIC   prod_product_category_id,
# MAGIC   prod_product_category_name,
# MAGIC   prod_parent_product_category_id,
# MAGIC   prod_parent_product_category_name,
# MAGIC   prod_grandparent_product_category_id,
# MAGIC   prod_grandparent_product_category_name,
# MAGIC   _tf_create_date,
# MAGIC   _tf_update_date
# MAGIC )
# MAGIC SELECT
# MAGIC   c.product_category_id,
# MAGIC   c.name,
# MAGIC   p.product_category_id AS prod_parent_product_category_id,
# MAGIC   p.name AS prod_parent_product_category_name,
# MAGIC   gp.product_category_id AS prod_grandparent_product_category_id,
# MAGIC   gp.name AS prod_grandparent_product_category_name,
# MAGIC   current_timestamp(),
# MAGIC   current_timestamp()
# MAGIC FROM silver.productcategory c
# MAGIC LEFT JOIN silver.productcategory p
# MAGIC   ON c.parent_product_category_id = p.product_category_id
# MAGIC LEFT JOIN silver.productcategory gp
# MAGIC   ON p.parent_product_category_id = gp.product_category_id;
# MAGIC
# MAGIC -- Ajout de la clé de la dim_product_category dans la dim_product
# MAGIC CREATE OR REPLACE TABLE gold.dim_product (
# MAGIC   _tf_dim_product_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) PRIMARY KEY NOT NULL,
# MAGIC   prod_product_id INT,
# MAGIC   prod_name STRING,
...
# MAGIC   prod_weight DECIMAL(8,2),
# MAGIC   prod_product_category_id INT,
# MAGIC   _tf_dim_product_category_id BIGINT REFERENCES gold.dim_product_category(_tf_dim_product_category_id),
# MAGIC   prod_product_model_id INT,
# MAGIC   prod_sell_start_date TIMESTAMP,
# MAGIC   prod_sell_end_date TIMESTAMP,
# MAGIC   prod_discontinued_date TIMESTAMP,
...
# MAGIC   p.weight,
# MAGIC   p.product_category_id,
# MAGIC   dpc._tf_dim_product_category_id,
# MAGIC   p.product_model_id,
# MAGIC   p.sell_start_date,
# MAGIC   p.sell_end_date,
# MAGIC   p.discontinued_date,
...
# MAGIC LEFT JOIN silver.productmodel pm
# MAGIC   ON p.product_model_id = pm.product_model_id
# MAGIC LEFT JOIN gold.dim_product_category dpc
# MAGIC   ON p.product_category_id = dpc.prod_product_category_id;
